...
if DESIGN == "mult":
    csv_file = csv_path / "tb_mult_wfifos_wishbone_latency.csv"
elif DESIGN == "multp-wfifos":
    csv_file = csv_path / "tb_multp_wfifos_wishbone_latency.csv"
elif DESIGN == "multp":
    csv_file = csv_path / "tb_multp_wishbone_latency.csv"
else:
