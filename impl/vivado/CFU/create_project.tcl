...
set_property library neorv32 [get_files [glob $mult/*.vhd]]
set_property library neorv32 [get_files [glob $multp/*.vhd]]

## Design: processor subsystem template, and (optionally) BoardTop and/or other additional sources (Mult(P) via CFU is included. That is all multipliers, mult_wfifos, multp_wfifos and multp. Each with its own instruction)

set fileset_design $mult/CFU/neorv32_mults_cfu.vhd
