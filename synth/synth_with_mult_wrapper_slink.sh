...
cp rtl/mult_wrapper/streamlink/neorv32_application_image.vhd neorv32-setups/neorv32/rtl/core
...
ghdl -i --workdir=build --work=neorv32 ../rtl/mult_wrapper/src/*.vhd
ghdl -i --workdir=build --work=neorv32 ../rtl/mult_wrapper/streamlink/neorv32_test_top_slink.vhd
